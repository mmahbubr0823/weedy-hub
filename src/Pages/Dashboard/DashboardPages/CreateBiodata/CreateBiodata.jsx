...
const CreateBiodata = () => {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            const res = await axios.post('https://api.imgbb.com/1/upload?key=f693e6b0c879da2b2b6de4c871fffa05', imgForm,
            )
            const ProfileImage = res.data.data.display_url
            const formData = {
                ...data, ProfileImage
            }
            const postData = await insertData.post('/members', formData)
    ...
    const divisions = ['Dhaka', 'Rajshahi', 'Rangpur', 'Khulna', 'Barishal', 'Cha˻agram', 'Maymansign', 'Sylhet'];
